namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCSharpProcessMethodsWrapper

	/// <exclude/>
	public class UsrCSharpProcessMethodsWrapper : ProcessModel
	{

		public UsrCSharpProcessMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			var esq = new EntitySchemaQuery(UserConnection.EntitySchemaManager, "UsrRealtyClassic"); 
